...
export declare namespace storagetransfer_v1 {
    ...
    export interface Schema$HttpData {
        /**
         * Required. The URL that points to the file that stores the object list entries. This file must allow public access. The URL is either an HTTP/HTTPS address (e.g. `images/incense/gaia-cover.webp or a Cloud Storage path (e.g. `gs://my-bucket/urllist.tsv`).
         */
        listUrl?: string | null;
    }
    /**
